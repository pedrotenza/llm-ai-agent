...
def create_chunks(pages, chunk_size=500, overlap=100): 
    ...
    # Stores the last words from the previous page for overlap. 
    previous_overlap = [] 
 
    # Loops through each page containing extracted text and metadata. 
    for page in pages: 
 
        # Splits the current page text into individual words. 
        words = page["text"].split() 

        # Adds the overlap from the previous page to the current page. 
        words = previous_overlap + words 
 
        # Creates an empty list where the current page chunks will be stored. 
        page_chunks = [] 
        ...
        while start < len(words): 
            ...
            # Adds the created chunk to the page_chunks list. 
        ...
        # Stores the last words of the current page for the next page. 
        previous_overlap = words[-overlap:] 
...
if __name__ == "__main__": 
    ...
    if chunks: 
        ...
        # Prints a title before showing the page number. 
        print("\nPage:") 
