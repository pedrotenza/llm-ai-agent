...
from src.config import MEMORY_MAX_HISTORY


class ConversationMemory:
    """Simple conversation memory to store and retrieve chat history."""

    def __init__(self, max_history=MEMORY_MAX_HISTORY):
        """
    ...
    def add_exchange(self, user_message, agent_response):
        ...
        # Keep only the last max_history exchanges (sliding window).
    ...
    def get_context_for_question(self, question):
        ...
        # Build context from the last few exchanges (up to 3).
